...
This defense loads mobilenet_v1 checkpoint and classifies all images
...
tf.flags.DEFINE_string(
    'checkpoint_path', '', 'Path to checkpoint for mobilenet_v1 network.')
...
def load_images(input_dir, batch_shape):
  ...
  for filepath in tf.gfile.Glob(os.path.join(input_dir, '*.png')):
    ...
    # Images for mobilenet_v1 classifier are normalized to be in [-1, 1] interval.
